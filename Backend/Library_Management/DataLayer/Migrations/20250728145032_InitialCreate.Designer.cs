...
namespace DataLayer.Migrations
{
    ...
    [Migration("20250728145032_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataLayer.Entities.BorrowOrder", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DataLayer.Entities.BorrowRecord", b =>
                {
                    ...
                    b.Property<string>("BorrowOrderId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DataLayer.Entities.CartItem", b =>
                {
                    ...
                    b.HasIndex(new[] { "BookId" }, "IX_cart_items_book_id");
            ...
            modelBuilder.Entity("DataLayer.Entities.BorrowRecord", b =>
                {
                    b.HasOne("DataLayer.Entities.BorrowOrder", "BorrowOrder")
                        .WithMany("BorrowRecords")
                        .HasForeignKey("BorrowOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
